...
public class FAQFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        groups = new String[]{
                "Comment voter par l'application mobile ?",
                "L'application est-elle utilisable par les français vivants à l'étranger ?",
                "A propos"
        };
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        lv = (ExpandableListView) view.findViewById(R.id.elv);
    ...
    public class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (convertView == null) {
                convertView = inf.inflate(R.layout.elv_child_faq, parent, false);
                holder = new ViewHolder();

                holder.text = (TextView) convertView.findViewById(R.id.tv_element_faq);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = inf.inflate(R.layout.elv_header_faq, parent, false);
